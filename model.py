...
#   lines = []
#   with open('../project3_data/driving_log.csv') as csvfile:
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                name = '../project3_data/IMG/'+batch_sample[0].split('/')[-1]
...
#measurements = []
#for line in lines:
#    source_path = line [0]  # center, left, right
#    filename = source_path.split('/')[-1]
#    current_path = '../project3_data/IMG/'+filename
...
history_object = model.fit_generator(train_generator,
    samples_per_epoch = len(train_samples)*2, #data augmented
